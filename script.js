function clearAll() {
  document.querySelector(".meme-content").textContent = " ";
  document.querySelector(".joke-content").textContent = " ";
  document.querySelector(".quote-content").textContent = " ";
  document.querySelector(".riddle-content").textContent = " ";
}
...
function revealAnswers() {
  ...
  if (answer === null) {
    ...
    alert("aiyyo!! already revealed na");
  }
}
